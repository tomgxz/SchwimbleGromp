...
_slutSuccess = [
    "You take a giant banana up the ass. You gained {amount} for your hard work.",
    "You let some old man take a peek at your goods for {amount}.",
    "You suck like a real pro! You even got tipped {amount} for it.",
    "Your used underwear was bought on eBay for {amount}... yikes.",
    "You fucked a traffic cone and found {amount} inside it.",
    "You get hired for some nude modeling. Pays well, as you walk off with {amount}",
    "You work as a lubricant tester and earn {amount}.",
    "Your friend pays you {amount} for you to worship her feet"
]
_slutFail = [
    "You were caught gettin' it on with a police officer, and have been fined {amount}.",
    "Your library masturbation video goes wrong when you squirt all over a rare and historic book, costing you {amount}.",
...
def work(): return _work
def crime(): return _crimes
def slutSuccess(): return _slutSuccess
def slutFail(): return _slutFail
